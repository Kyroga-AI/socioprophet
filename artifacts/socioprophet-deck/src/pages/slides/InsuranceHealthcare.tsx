  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginTop: "1.5vh" }}>
        ...
        <div style={{ fontSize: "2.2vw", fontWeight: 400, color: "#7E889A" }}>Market &mdash; Insurance &amp; Healthcare</div>
      </div>

      <div style={{ position: "absolute", top: "32vh", left: "8vw", fontSize: "25vw", fontWeight: 700, color: "#14161F", lineHeight: 0.8, zIndex: 0, userSelect: "none", letterSpacing: "-0.05em" }}>15</div>
      ...
      <div style={{ flexGrow: 1, display: "flex", flexDirection: "column", justifyContent: "flex-start", zIndex: 1, position: "relative", marginTop: "2.5vh" }}>
        ...
        <div style={{ marginTop: "4.5vh", maxWidth: "78vw", borderLeft: "0.4vh solid #866CF7", paddingLeft: "1.8vw", fontSize: "2.4vw", lineHeight: 1.35, fontStyle: "italic", color: "#C7CDDA" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "0.1vh solid #222A3A", paddingTop: "1.8vh", marginTop: "auto", fontFamily: "'Space Mono', monospace", fontSize: "2.2vw", color: "#9AA3B4", zIndex: 1 }}>
        ...
        <div style={{ color: "#59617A" }}>15 / 19</div>
      </div>
    </div>
  );
}
