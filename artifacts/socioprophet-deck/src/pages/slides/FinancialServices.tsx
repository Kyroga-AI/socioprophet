  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginTop: "1.5vh" }}>
        ...
        <div style={{ fontSize: "2.2vw", fontWeight: 400, color: "#7E889A" }}>Market &mdash; Financial Services</div>
      </div>

      <div style={{ position: "absolute", top: "32vh", left: "8vw", fontSize: "25vw", fontWeight: 700, color: "#14161F", lineHeight: 0.8, zIndex: 0, userSelect: "none", letterSpacing: "-0.05em" }}>14</div>
      ...
      <div style={{ flexGrow: 1, display: "flex", flexDirection: "column", justifyContent: "flex-start", zIndex: 1, position: "relative", marginTop: "2.5vh" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.9vh", maxWidth: "76vw" }}>
          <div style={{ display: "flex", gap: "1.6vw", alignItems: "baseline" }}>
            ...
            <div style={{ fontSize: "2.45vw", lineHeight: 1.32 }}>Highest-stakes AI adoption meets the heaviest supervisory scrutiny.</div>
          </div>
          <div style={{ display: "flex", gap: "1.6vw", alignItems: "baseline" }}>
            <div style={{ width: "1.6vw", height: "0.35vh", backgroundColor: "#3FB6C2", flexShrink: 0, marginTop: "1.7vh" }} />
            <div style={{ fontSize: "2.45vw", lineHeight: 1.32 }}>Use cases: credit and underwriting support, surveillance, research, client servicing.</div>
          </div>
          <div style={{ display: "flex", gap: "1.6vw", alignItems: "baseline" }}>
            <div style={{ width: "1.6vw", height: "0.35vh", backgroundColor: "#3FB6C2", flexShrink: 0, marginTop: "1.7vh" }} />
            <div style={{ fontSize: "2.45vw", lineHeight: 1.32 }}>Sovereignty and evidence are precisely what model-risk and audit teams require.</div>
          </div>
          <div style={{ display: "flex", gap: "1.6vw", alignItems: "baseline" }}>
            <div style={{ width: "1.6vw", height: "0.35vh", backgroundColor: "#3FB6C2", flexShrink: 0, marginTop: "1.7vh" }} />
            <div style={{ fontSize: "2.45vw", lineHeight: 1.32 }}>Maps directly to SR 26-2, FCA, DORA, and MAS expectations.</div>
          </div>
        </div>

        <div style={{ marginTop: "4vh", maxWidth: "78vw", borderLeft: "0.4vh solid #866CF7", paddingLeft: "1.8vw", fontSize: "2.4vw", lineHeight: 1.35, fontStyle: "italic", color: "#C7CDDA" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "0.1vh solid #222A3A", paddingTop: "1.8vh", marginTop: "auto", fontFamily: "'Space Mono', monospace", fontSize: "2.2vw", color: "#9AA3B4", zIndex: 1 }}>
        ...
        <div style={{ color: "#59617A" }}>14 / 19</div>
      </div>
    </div>
  );
}
