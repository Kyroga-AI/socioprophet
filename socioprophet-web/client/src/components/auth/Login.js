      ...
      <div className="page-wrapper_login">
        <div className="contentNode_login">
          <div className="landing-wrapper_login">
            ...
            <footer className="landing-footer_login">
              <a className="landing-footer-link_login" href="#" target="_blank"><strong>Contact</strong></a>
              <a className="landing-footer-link_login" href="#" target="_blank"><strong>Privacy</strong></a>
              <a className="landing-footer-link_login" href="#" target="_blank"><strong>Terms of Use</strong></a>
              <a className="landing-footer-link_login" href="#" target="_blank"><strong>Support</strong></a>
            </footer>
