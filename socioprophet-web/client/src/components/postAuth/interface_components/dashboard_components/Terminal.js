...
class Terminal extends Component {
  ...
  render() {
    if (this.state.isPoppedOut) {
      var popout = (
        <button className="popout-btn" onClick={this.popoutClosed}>
          &#8690;
        </button>
      );
      return (
        <div className="container">
          ...
          <div className="drawer">
            <div className="drawer--bar">
              ...
              <div className="drawer--bar--search"></div>
            </div>
      ...
      var popout = (
        <button className="popout-btn" onClick={this.popout}>
          &#8689;
        </button>
      );
      return (
