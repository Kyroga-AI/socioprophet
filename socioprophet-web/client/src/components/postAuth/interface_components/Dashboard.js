...
import ContentTicker from "./dashboard_components/ContentTicker";
import Pages from "./dashboard_components/Pages";
import Terminal from "./dashboard_components/Terminal";
import News from "./dashboard_components/content/News";
...
class Dashboard extends Component {
  ...
  render() {
    return (
      <SplitterLayout
        customClassName={
          this.state.barVisible ? "splitter__show" : "splitter__hide"
        }
        vertical={true}
      >
        ...
        <div className="splitter__secondary">
          <button
            className={this.state.barVisible ? "toggle--down" : "toggle--up"}
            type="button"
