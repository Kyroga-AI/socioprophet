  ...
  render() {
    ...
    const Projects = () => (
      ...
      >
        ...
        <path d="M14 8h8v2h-8zm0 7h8v2h-8zm0 7h8v2h-8z"></path>
      </svg>
    );
    ...
    const DashboardIcon = () => (
      <svg
        viewBox="0 0 24 24"
        className="bx--parent-item__link--taxonomy-icon"
        fillRule="evenodd"
      >
          ...
          render={({ isSideNavExpanded, onClickSideNavExpand }) => (
            <Header aria-label="SocioProphet Platform">
              ...
              <HeaderNavigation aria-label="SocioProphet Platform">
                ...
                <HeaderMenuItem>
                  <Link className="header--link" to="/law">
                    Law & Regulation
                  </Link>
                </HeaderMenuItem>
                <HeaderMenuItem>
                  <Link className="header--link" to="/society">
                    People & Society
                  </Link>
                </HeaderMenuItem>
                <HeaderMenuItem>
                  <Link className="header--link" to="/industry">
                    Economy & Industries
                  </Link>
                </HeaderMenuItem>
                <HeaderMenuItem>
                  <Link className="header--link" to="/markets">
                    Capital & Markets
                  </Link>
                </HeaderMenuItem>
                <HeaderMenuItem>
                  ...
                  <SideNavItems className="black">
                    ...
                    >
                      <li className="sidenav__item">
                        <Link className="sidenav--link" to="/projects1">
                          New Project
                        </Link>
                      </li>
                      ...
                      <SideNavMenuItem>Trending Projects</SideNavMenuItem>
                    </SideNavMenu>

                    <SideNavMenu
                      className="invert"
                      defaultExpanded={true}
                      renderIcon={EconomicProphetIcon}
                      title="Economic Prophet"
                    >
                      <SideNavMenuItem href="#">
                      ...
                      <SideNavMenuItem href="#">Social Profit</SideNavMenuItem>
                    </SideNavMenu>
                    ...
                    >
                      <SideNavMenuItem href="#">Trending</SideNavMenuItem>
                      <SideNavMenuItem href="#">
                    ...
                    <SideNavMenu
                      ...
                      title="Data Studio"
                    >
                      <SideNavMenuItem href="#">My Data</SideNavMenuItem>
                      <SideNavMenuItem href="#">Community Data</SideNavMenuItem>
                      <SideNavMenuItem href="#">
                        Data Marketplace
                      </SideNavMenuItem>
                      <SideNavMenuItem href="#">
                    ...
                    >
                      ...
                      <SideNavMenuItem href="#">Assets</SideNavMenuItem>
                      <SideNavMenuItem href="#">Deployment</SideNavMenuItem>
                      <SideNavMenuItem href="#">Inventory</SideNavMenuItem>
                    </SideNavMenu>
                  </SideNavItems>
                </SideNav>
              </div>
