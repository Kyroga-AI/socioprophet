...
function onKey(e: KeyboardEvent) {
  ...
  if (mail.paletteOpen || typing) return;
...
<template>
  <div class="mail">
    <aside class="rail">
      <button class="compose"><i class="ti ti-pencil"></i> Compose</button>
    ...
    <section class="read" v-if="mail.current">
      ...
      <footer class="replybar">
        <input v-model="reply" placeholder="Reply…  (R)" />
        <span class="muted small"><i class="ti ti-bolt"></i> AI draft</span>
      </footer>
    </section>
...
.compose { background: #1a73e8; color: #fff; border: 0; border-radius: 8px; padding: 9px; margin-bottom: 8px; cursor: pointer; }
