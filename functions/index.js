...
exports.leadCapture = onRequest(async (req, res) => {
  ...
  try {
    ...
    const doc = {
      ...
      audience,
      email,
      firstName: s(body.first_name, 128),
      lastName: s(body.last_name, 128),
      organisation: s(body.organisation, 256),
      role: s(body.role, 128),
      productInterest: s(body.product_interest, 64),
