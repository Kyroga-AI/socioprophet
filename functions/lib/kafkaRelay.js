...
function buildEnvelope(outboxDoc) {
  ...
  return {
    ...
    summary: {
      ...
      firstName: sv(summary.firstName),
      lastName: sv(summary.lastName),
      organisation: sv(summary.organisation),
      role: sv(summary.role),
      productInterest: sv(summary.productInterest),
